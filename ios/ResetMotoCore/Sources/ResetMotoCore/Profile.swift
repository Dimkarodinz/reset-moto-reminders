...
public struct ResetMotoProfile: Codable, Equatable, Sendable {
  ...
  public let dtcDescriptionProvenance: [String: DTCDescriptionProvenance]
  ...
  public static func decode(_ data: Data) throws -> ResetMotoProfile {
    ...
    guard version == 3 else { throw ProfileError.unsupportedSchema(version) }
    do {
  ...
  private func validate() throws {
    ...
    guard dtcDescriptionProvenance.keys.allSatisfy({ dtcDescriptions[$0] != nil }) else {
      throw ProfileError.invalid("DTC provenance references a missing description")
    }
  }
}

public enum DTCDescriptionProvenance: String, Codable, Equatable, Sendable {
  case oemConfirmed = "oem_confirmed"
  case vehicleObserved = "vehicle_observed"
  case openDataGeneric = "open_data_generic"
  case inferred
  case unverified
}
