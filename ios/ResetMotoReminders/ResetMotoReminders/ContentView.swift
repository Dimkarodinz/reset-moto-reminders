    ...
    Card {
      ...
      ForEach(session.dtcs) { dtc in
        VStack(alignment: .leading, spacing: 3) {
          ...
          Text(L10n.text(dtc.descriptionProvenance.localizationKey))
            .font(.caption2)
            .foregroundStyle(.secondary)
        }
        .padding(.vertical, 3)
...
private extension DTCDescriptionProvenance {
  var localizationKey: String {
    switch self {
    case .oemConfirmed: "dtc_source_oem_confirmed"
    case .vehicleObserved: "dtc_source_vehicle_observed"
    case .openDataGeneric: "dtc_source_open_data_generic"
    case .inferred: "dtc_source_inferred"
    case .unverified: "dtc_source_unverified"
    }
  }
}
