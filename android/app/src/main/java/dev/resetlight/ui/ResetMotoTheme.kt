...
private val ResetMotoDarkColors = darkColorScheme(
...
/** Fixed high-contrast dark presentation for the rider-facing application. */
@Composable
fun ResetMotoTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = ResetMotoDarkColors,
        content = content,
    )
}
