...
The v0.12.0 release (`versionCode 16`) packages the family-composed motorcycle catalogue in [`../ecu-maps/README.md`](../ecu-maps/README.md), experimental OBDLink CX BLE support and separate experimental Android-only OBDLink MX, LX and MX+ Classic profiles. DTC rows include localized provenance labels for observed, CC0 generic, inferred and unverified descriptions. It retains the one-time safety acknowledgement, bounded writes, packaged legal notices and the separation from broader research capture:
...
| [`../dtc-maps/triumph-tiger-900-gt-pro-2021.en.dtcmap.yaml`](../dtc-maps/triumph-tiger-900-gt-pro-2021.en.dtcmap.yaml) | Publishable observed-code and CC0 generic DTC lookup with neutral fallback |
