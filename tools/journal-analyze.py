...
def build_profile(adapter_map: dict, ecu_map: dict, dtc_map: dict) -> Profile:
    ...
    return Profile(
        ...
        dtc_generic_entries=dtc_map.get("generic_entries") or {},
...
def lookup_dtc(profile: Profile, display_code: str) -> str:
    ...
    open_data = profile.dtc_generic_entries.get(base_code)
    if open_data:
        return f"{open_data} [generic_open_data]"
