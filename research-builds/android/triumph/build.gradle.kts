...
android {
    namespace = "dev.resetlight.research.triumph"
    compileSdk = 36

    defaultConfig {
        applicationId = "dev.resetlight.research.triumph"
        minSdk = 26
        targetSdk = 36
        versionCode = 3
        versionName = "0.3.0"
...
android.sourceSets["main"].java.srcDirs(
    ...
    sharedMain.resolve("features/dtc"),
    sharedMain.resolve("features/service"),
...
val profileSources = listOf(
    ...
    rootProject.file("../ecu-maps/tiger-900-gt-pro-2021.ecumap.yaml"),
    rootProject.file("../ecu-maps/ecumap.schema.json"),
    rootProject.file("../dtc-maps/triumph-tiger-900-gt-pro-2021.en.dtcmap.yaml"),
    rootProject.file("../dtc-maps/dtcmap.schema.json"),
)
...
val generateProfileAssets = tasks.register<Sync>("generateProfileAssets") {
    ...
    doFirst {
        require(profileSources.all { it.isFile }) { "Every research profile source must exist" }
    }
}
