...
private val TriumphResearchDarkColors = darkColorScheme(
...
/** Fixed dark presentation shared visually with Reset Moto Reminders. */
@Composable
fun TriumphResearchTheme(content: @Composable () -> Unit) {
    MaterialTheme(
        colorScheme = TriumphResearchDarkColors,
        content = content,
    )
}
